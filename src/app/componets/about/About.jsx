      ...
      <section className="text-white md:mt-8 body-font bg-[black] py-4">
        <div className="container mx-auto flex lg:px-5 px-2 pt-2   md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center ">
            <h1
              className={`${styles.title} font-times title-font text-2xl lg:text-3xl mb-4 font-bold text-[white] text-center justify-center align-center tracking-widest md:leading-realxed `}
