      ...
      <footer className="bg-black">
        ...
        >
          <div className={" lg:w-2/4 w-full  "}>
            <h1
              className={`${styles.title} title-font sm:text-4xl lg:text-5xl mb-4 font-medium  mt-8 tracking-widest md:leading-realxed text-black `}
            >
            ...
            <div className={"flex  items-center justify-left"}>
              ...
              <div className="flex mt-3 w-48 h-14 border bg-black hover:bg-slate-600 cursor-pointer text-white rounded-lg items-center justify-center">
                <div className="mr-3">
        ...
        <div className=" container w-full bg-black flex flex-col items-center justify-between  py-4 px-8 mt-4  sm:space-y-0 sm:flex-row">
          <a href="/" className=" flex items-center  ">
            ...
            <span
              className={` ${styles.title} font-bold ml-3 text-4xl tracking-wider text-white`}
            >
              H2O
            </span>
          </a>

          <p className="text-sm text-white text-center dark:text-gray-300">
